<a href="https://github.com/Stiv455/LinqqWatch">
...
- Поддерживаемые форматы сообщений: Фото, Видео, Голосовые сообщения, Стикеры
...
- Переключение между основным чатом и архивным

Для корректной работы в фоновом режиме отключите остановку процесса в фоне 
